public class ReportService {
        ...
        // عرض عدد المركبات
        public void vehicleCountReport(
                        VehicleService vehicleService) {

                System.out.println(
                                "Total Vehicles = "
                                                + vehicleService.getVehiclesCount());
        }
        ...
        // عرض عدد العقود
        public void contractCountReport(
        ...
        public void totalRevenueReport(
                ...
                for (RentalContract contract : rentalService.getContracts()) {
                        ...
                        total += contract.calculateTotalCost();
                }
        ...
        public void availableVehiclesReport(
                        VehicleService vehicleService) {
